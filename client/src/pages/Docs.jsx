...
const Docs = () => {
    ...
    const content = <div>
        ...
        <div className=" flex flex-col mt-4 justify-center items-center bg-gray-100 py-6 rounded-md  w-3/4 mx-auto">
            <h3 className="text-[#232327] text-[28px] leading-[140%] font-semibold">eComer</h3>
            <h3 className="text-4xl font-bold text-[#696969]">Documentation</h3>
        </div>
        <div className="w-full h-[1px] bg-[#0000001A] mt-10 mb-12"></div>

        <div id="introduction">
            <h1 className="text-[#232327] font-semibold text-[32px]">Introduction to eComer</h1>
