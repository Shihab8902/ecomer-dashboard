...
const Setup = () => {
    ...
    const content = <div id="setup">
        ...
        <div id="login" className="mt-6">
            ...
            <img className="rounded-lg my-3 w-[90%] border-[#EAEAEA]" src={login} alt="Login with Google example" />
        </div>
        ...
        <div id="create-store" className="mt-6">
            ...
            <img className="rounded-lg my-3 w-[90%] border-[#EAEAEA]" src={storeCreation} alt="Store Creation example" />
        ...
        <div id="store-id" className="mt-6">
            ...
            <img className="rounded-lg my-3 border border-[#EAEAEA] w-[90%]" src={storeId} alt="Store id example" />
        </div>
        ...
        <div id="payment-methods" className="mt-6">
            ...
            <img className="rounded-lg my-3 border border-[#EAEAEA] w-[90%]" src={paymentMethods} alt="Payment method configuration example" />
        </div>
