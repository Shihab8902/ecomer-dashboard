...
const Checkout = () => {
    ...
    const content = <div id="setup">
        ...
        <div id="checkout-cod" className="mt-6">
            ...
            <img className="rounded-lg my-3 w-[90%] border border-[#EAEAEA]" src={formId} alt="Form id example" />
        ...
        <ul className='ml-5'>
            ...
            <img className="rounded-lg my-3 w-[90%] border border-[#EAEAEA]" src={inputFieldName} alt="Input field name example" />
            ...
            <img className="rounded-lg my-3 w-[90%] border border-[#EAEAEA]" src={modifiedCode} alt="Modified code preview" />
        </ul>
