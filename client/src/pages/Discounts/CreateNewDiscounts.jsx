            ...
            <div className="w-full max-w-[600px] mb-[80px] md:mb-0  mx-auto pt-[88px] md:pt-[128px] pb-5">
                ...
                <div className="w-full bg-white py-3 md:py-5 px-4 md:px-8 rounded-[4px] md:rounded-lg mt-2 md:mt-4">
                    ...
                    <label className="flex items-center gap-1" htmlFor="minRequiredAmount">
                        <input onClick={(e) => setExpendedMinAmountValue(e.target.value)} className="cursor-pointer w-4 h-4" defaultChecked type="radio" name="minRequiredAmount" id="minRequiredAmount" value="" />
                    ...
                    <label className="flex items-center gap-1 mt-2" htmlFor="minRequiredAmount">
                        <input onClick={(e) => setExpendedMinAmountValue(e.target.value)} className="cursor-pointer w-4 h-4" type="radio" name="minRequiredAmount" id="minRequiredAmount2" value="fixedAmount" />
